...
$pdf->SetLineWidth(.3);
$pdf->SetFont('','B');
$pdf->Cell(30,5,'Computer Science Department',1);
$pdf->Cell(30,5,'Subjec Allotment List',1);
...
$pdf->Cell(10,3,'SEMESTER',1);
$pdf->Cell(40,3,'SUBJECT NAME WITH CODE',1);
if($frow)
{
	do
	{	
