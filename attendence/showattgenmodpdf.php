...
$scode=$_POST['subj'];
$sem=$_POST['sem'];
$monthf=$_POST['monthfrom'];
$montht=$_POST['monthto'];
//print"$scode==$month";
...
$pdf->Cell(30,5,"subjec code:$scode",1);
$pdf->Cell(30,5,"subject name:$subname",1);
$pdf->Cell(30,5,"staff code:$fcode",1);
$pdf->Cell(35,5,"staff name:$fname",1);
$pdf->Ln();
/*$pdf->Cell(30,5,$scode,1);
$pdf->Cell(30,5,$subname,1);
$pdf->Cell(30,5,$fcode,1);
$pdf->Cell(35,5,$fname,1);
$pdf->Ln();
*/
...
{	
	...
	$ctquery="select doc from  classtakendate where scode='$scode' and month(doc) BETWEEN '$monthf' AND '$montht'";
	$ctresult=mysqli_query($conn,$ctquery);
	$totalclass=mysqli_num_rows($ctresult);

	
	$heading=array("SLN","Registe No","Name");
